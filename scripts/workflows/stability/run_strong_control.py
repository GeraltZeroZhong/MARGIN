#!/usr/bin/env python
"""Fit C+ on CATH teacher actions and export locked-panel residuals."""
...
from margin.studies.stability.strong_control import run_strong_control
...
def main() -> None:
    ...
    paths = run_strong_control(config)
